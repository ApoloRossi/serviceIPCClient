package com.example.ipcserver.ui.aidl
...
class AidlFragment : Fragment(), ServiceConnection, View.OnClickListener {
    ...
    private fun connectToRemoteService() {
        ...
        val pack = IPCExample::class.java.`package`
        pack?.let {
    ...
    override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
        ...
        iRemoteService = IPCExample.Stub.asInterface(service)
